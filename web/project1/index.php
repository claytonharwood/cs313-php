...
<!DOCTYPE html>
	...
	<body>
		...
		<h3>Card Info</h3>
		<?php
	      foreach ($db->query('SELECT cardinfo.year, cardinfo.cardtype, cardinfo.cardnumber FROM cardInfo INNER JOIN player ON cardinfo.playerid=player.playerid') as $row)
	       {
