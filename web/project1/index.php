...
<!DOCTYPE html>
	...
	<body>
		...
		<h3>Card Info</h3>
		<?php
	      foreach ($db->query('SELECT cardinfo.playerid, cardinfo.year, cardinfo.cardtype, cardinfo.cardnumber FROM cardinfo INNER JOIN player ON cardinfo.playerid=player.playerid') as $row)
	       {
